...
class Api {
    ...
    var page = 1
    var category = 1
    var dates = "2020-01-01,2020-12-31"
    var sortBy = "-added"
    ...
    func getGames(completion: @escaping (Result<([Games], next: String?, previous: String?), Error>) -> Void) {
        ...
        guard let url = URL(string: "https://api.rawg.io/api/games?platforms=4&page_size=1&dates=2020-01-01,2020-12-31&ordering=-added") else { return }
